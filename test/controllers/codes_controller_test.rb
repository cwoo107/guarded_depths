...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { code: @code.code, forward_address: @code.forward_address, user_id: @code.user_id, webhook: @code.webhook } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { code: @code.code, forward_address: @code.forward_address, user_id: @code.user_id, webhook: @code.webhook } }
